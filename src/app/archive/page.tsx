              ...
              return (
                <section key={monthKey}>
                  <h2 className="text-sm font-mono font-bold text-slate-300 uppercase tracking-wider mb-3 flex items-center gap-2">
                    <CalendarDays className="h-4 w-4 text-[#FF7905]" />
                    {monthLabel}
                  </h2>
                    ...
                    {byMonth.get(monthKey)!.map((dateStr) => {
                      ...
                      return (
                        <Link
                          ...
                          className="group bg-[#11131F] border border-white/10 hover:border-[#FF7905]/40 rounded-xl p-4 transition-all duration-150"
                        >
                          <div className="text-lg font-mono font-extrabold text-white group-hover:text-[#FF7905]">
                            {prettyDate(dateStr).split(',')[0]}
                          </div>
                          <div className="text-xs font-mono text-slate-500 mt-0.5">
                            {dateStr}
                          </div>
                          <div className="mt-2 inline-flex items-center gap-1 text-[11px] font-mono text-slate-400 group-hover:text-[#FF7905]">
